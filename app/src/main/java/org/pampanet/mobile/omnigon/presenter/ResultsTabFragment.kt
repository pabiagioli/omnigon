...
import org.pampanet.mobile.omnigon.utils.getResults
...
class ResultsTabFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        getResultsAsync(rootView)
        return rootView
    }

    fun getResultsAsync(rootView: View) = uiScope.launch {
        val results = async { getResults() }
        rootView.matches_list.adapter = MatchListAdapter(results.await())
